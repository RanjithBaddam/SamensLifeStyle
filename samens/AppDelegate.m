...
didSignInForUser:(GIDGoogleUser *)user
    ...
    NSArray *socialNetworkLoginDetailsArray = [NSArray arrayWithObjects:userId,idToken,fullName,email, nil];
    NSLog(@"%@",socialNetworkLoginDetailsArray);
    [NSUserDefaults.standardUserDefaults setObject:socialNetworkLoginDetailsArray forKey:@"SocialMedia"];
        
    NSString *urlInstring =[NSString stringWithFormat:@"http://samenslifestyle.com/samenslifestyle123.com/samens_mob/registration_for_social_media.php"];
    NSURL *url=[NSURL URLWithString:urlInstring];
    NSMutableURLRequest *request=[NSMutableURLRequest requestWithURL:url];
    [request setHTTPMethod:@"POST"];
    NSString *params = [NSString stringWithFormat:@"userid=%@&name=%@&type=%@&image=%@&email=%@",userId,fullName,@"G",imgUrlString,email];
    NSLog(@"%@",params);
